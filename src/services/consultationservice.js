...
export const getConsultationById  = (id) => Api.get('/consultation/'+ id).then(res => res.data);
export const getConsultationByEtudiant  = (id) => Api.get('/consultation/byetudiant/'+ id).then(res => res.data);
