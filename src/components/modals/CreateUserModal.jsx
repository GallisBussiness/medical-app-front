...
const CreateUserModal = ({ isOpen, onResolve, onReject }) => {
  ...
  return (
    ...
    <div className="mb-3">
            ...
            <input type="email" {...field} className="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-green-300 bg-white bg-clip-padding px-3 py-2 font-normal text-green-700 outline-none transition-all placeholder:text-green-500 focus:border-green-300 focus:outline-none" id="email" placeholder="Entrer votre Email" />
             )}/>
