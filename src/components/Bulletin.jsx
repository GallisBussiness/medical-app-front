          ...
          {data && (
            <div className="p-10 bg-white flex items-center justify-center">
              <ul className="flex flex-col mb-0 rounded-lg w-full">
                <li className="relative block px-4 py-2 pt-0 pl-0 leading-normal rounded-t-lg text-sm text-inherit">
                  <strong className="text-slate-700">Date:</strong> &nbsp;{" "}
                  {format(parseISO(data?.date), "dd-MMMM-yyyy H:m:s", {
                    locale: fr,
                  })}
                </li>
                <li className="relative block px-4 py-2 pt-0 pl-0 leading-normal rounded-t-lg text-sm text-inherit">
                ...
                <li className="relative block px-4 py-2 pt-0 pl-0 leading-normal rounded-t-lg text-sm text-inherit">
                  <strong className="text-slate-700">Etablissement:</strong>{" "}
                  &nbsp; {data?.etablissement}
                </li>
                <li className="relative block px-4 py-2 pt-0 pl-0 leading-normal rounded-t-lg text-sm text-inherit">
                ...
                <li className="relative block px-4 py-2 pt-0 pl-0 leading-normal rounded-t-lg text-sm text-inherit">
                  <strong className="text-slate-700">Examens Demandés:</strong>{" "}
                  &nbsp;{" "}
                  {data?.examensDemandes?.split(",").map((e, i) => (
                    <Chip key={i} label={e} className="bg-red-200" />
                  ))}
                </li>
                <li className="relative block px-4 py-2 pt-0 pl-0 leading-normal rounded-t-lg text-sm text-inherit">
                  <strong className="text-slate-700">Par :</strong> &nbsp;{" "}
