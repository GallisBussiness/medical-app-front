...
function CreateEtablissementModal({ isOpen, onResolve, onReject }) {

    const defaultValues = {nom: '',  pseudo: ''};
  ...
  return (
    <>
       <Dialog header="Creer un Etablissement" visible={isOpen} onHide={() => onReject(false)} className="w-1/2">
...
export default create(CreateEtablissementModal);