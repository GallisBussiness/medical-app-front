...
function UpdateEtablissementModal({ isOpen, onResolve, onReject,etablissement }) {

    const defaultValues = {nom: etablissement.nom,  pseudo: etablissement.pseudo};
    ...
    const onUpdate = data => {
        onResolve({_id:etablissement._id,...data});
      };

  return (
    <>
    <Dialog header="Modifier un Etablissement" visible={isOpen} onHide={() => onReject(false)} className="w-1/2">
...
export default create(UpdateEtablissementModal)