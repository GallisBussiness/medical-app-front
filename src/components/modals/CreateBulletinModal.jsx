...
function CreateBulletinModal({ isOpen, onResolve, onReject,idDossier,idAuth }) {
    ...
    <div>
      ...
      <Controller control={control} name="etablissement" render={({field}) => (
            ...
            placeholder="entrer le service"
              ...
              <div className="my-5">
             <Button type="submit" className="bg-green-500 hover:bg-green-600"> CREER BULLETIN</Button>
            </div>
...
export default create(CreateBulletinModal)