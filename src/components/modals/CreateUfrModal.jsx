...
function CreateUfrModal({ isOpen, onResolve, onReject }) {
  ...
  return (
    <>
       <Dialog header="Creer un ufr" visible={isOpen} onHide={() => onReject(false)} className="w-1/2">
...
export default create(CreateUfrModal);