...
function CreateNiveauModal({ isOpen, onResolve, onReject }) {
  ...
  return (
    <>
       <Dialog header="Creer un Niveau" visible={isOpen} onHide={() => onReject(false)} className="w-1/2">
...
export default create(CreateNiveauModal)